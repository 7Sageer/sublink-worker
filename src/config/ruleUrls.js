...
export const SITE_RULE_SET_BASE_URL = 'https://gh-proxy.com/https://github.com/MetaCubeX/meta-rules-dat/raw/refs/heads/sing/geo/geosite/';
export const IP_RULE_SET_BASE_URL = 'https://gh-proxy.com/https://github.com/MetaCubeX/meta-rules-dat/raw/refs/heads/sing/geo/geoip/';
...
export function resolveRuleSetUrl(url, useGhProxy = true) {
	if (useGhProxy || !url.startsWith(GH_PROXY_PREFIX)) {
		return url;
	}
	return url.slice(GH_PROXY_PREFIX.length);
}
