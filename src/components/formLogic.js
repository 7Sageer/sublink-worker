    ...
    window.formData = function () {
        ...
        return {
            ...
            init() {
                ...
                this.useProxyProvider = localStorage.getItem('useProxyProvider') !== 'false';
                ...
                this.$watch('useProxyProvider', val => localStorage.setItem('useProxyProvider', val));
            ...
            async submitForm() {
                ...
                try {
                    ...
                    if (!this.useProxyProvider) params.append('use_proxy_provider', 'false');
            ...
            populateFormFromUrl(url) {
                ...
                this.useProxyProvider = params.get('use_proxy_provider') !== 'false';
