  ...
  const scriptContent = `
        window.formData = function() {
          return {
            ...
            loading: false,
            generatedLinks: null,
            processingText: ${JSON.stringify(t('processing'))},
            convertText: ${JSON.stringify(t('convert'))},
            ...
            applyPredefinedRule() {
              ...
              const rules = ${JSON.stringify(PREDEFINED_RULE_SETS)};
            ...
            saveBaseConfig() {
              ...
              alert(${JSON.stringify(t('saveConfigSuccess'))});
            },
            
            clearBaseConfig() {
              if (confirm(${JSON.stringify(t('confirmClearConfig'))})) {
                this.configEditor = '';
            ...
            clearAll() {
              if (confirm(${JSON.stringify(t('confirmClearAll'))})) {
                this.input = '';
            ...
            async submitForm() {
              ...
              try {
                ...
                alert(${JSON.stringify(t('errorGeneratingLinks'))});
              } finally {
                this.loading = false;
              }
            }
