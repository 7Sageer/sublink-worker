...
export const translations = {
  'zh-CN': {
    ...
    loginTitle: `${APP_NAME} - 登录验证`,
    loginDescription: '请输入部署环境中配置的访问密钥。',
    loginSecretLabel: '访问密钥',
    loginInvalidSecret: '密钥不正确，请重试。',
    loginSubmit: '登录',
    logout: '退出登录',
  ...
  'en-US': {
    ...
    loginTitle: `${APP_NAME} - Login`,
    loginDescription: 'Enter the access secret configured in the deployment environment.',
    loginSecretLabel: 'Access secret',
    loginInvalidSecret: 'The secret is incorrect. Please try again.',
    loginSubmit: 'Log in',
    logout: 'Log out',
