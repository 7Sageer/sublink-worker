...
export const translations = {
  ...
  'en-US': {
    ...
    mergeUserGroups: 'Merge Groups from Subscription',
  ...
  'fa': {
    ...
    mergeUserGroups: 'ادغام گروه‌های اشتراک',
  ...
  'ru': {
    ...
    mergeUserGroups: 'Объединить группы из подписки',
