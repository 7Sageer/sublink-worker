...
pageDescription: 'Subscription Link Converter Tool',
pageKeywords: 'subscription link, convert, Xray, SingBox, Clash, Surge',
pageTitle: 'Subscription Link Converter Tool',
ogTitle: 'Subscription Link Converter Tool',
...
customRuleGeoSiteTooltip: 'Site rules in SingBox come from https://github.com/malikshi/sing-box-geo/releases/latest/download/geosite.db，这意味着您的自定义规则必须在该仓库中',
customRuleGeoSitePlaceholder: 'e.g.: google,anthropic',
customRuleGeoIP: 'Geo-IP Rule Set',
customRuleGeoIPTooltip: 'IP rules in SingBox come from https://github.com/malikshi/sing-box-geo/releases/latest/download/geoip.db，这意味着您的自定义规则必须在该仓库中',
