...
export const translations = {
  'zh-CN': {
    ...
    pageKeywords: '订阅链接,转换,Xray,SingBox,Clash,Surge,Loon',
    ...
    groupByCountryTip: '仅 Clash/Surge/Loon/SingBox 生效',
    includeAutoSelect: '包含自动选择分组',
    useGhProxy: '通过 gh-proxy 下载规则集',
    useGhProxyTip: '关闭后直接从 GitHub 下载',
  ...
  'en-US': {
    ...
    pageKeywords: 'subscription link,converter,Xray,SingBox,Clash,Surge,Loon',
    ...
    groupByCountryTip: 'Clash/Surge/Loon/SingBox only',
    includeAutoSelect: 'Include Auto Select Group',
    useGhProxy: 'Download rule sets through gh-proxy',
    useGhProxyTip: 'Turn off to download directly from GitHub',
  ...
  'fa': {
    ...
    pageKeywords: 'لینک اشتراک,مبدل,Xray,SingBox,Clash,Surge,Loon',
    ...
    groupByCountryTip: 'فقط Clash/Surge/Loon/SingBox',
    includeAutoSelect: 'شامل گروه انتخاب خودکار',
    useGhProxy: 'دریافت مجموعه قوانین از طریق gh-proxy',
    useGhProxyTip: 'برای دریافت مستقیم از GitHub غیرفعال کنید',
  ...
  'ru': {
    ...
    pageKeywords: 'ссылка подписки,преобразование,Xray,SingBox,Clash,Surge,Loon',
    ...
    groupByCountryTip: 'Только для Clash/Surge/Loon/SingBox',
    includeAutoSelect: 'Включить группу автовыбора',
    useGhProxy: 'Загружать наборы правил через gh-proxy',
    useGhProxyTip: 'Отключите для прямой загрузки с GitHub',
