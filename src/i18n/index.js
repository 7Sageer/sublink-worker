...
export const translations = {
  'zh-CN': {
    ...
    protocolFilter: '协议过滤',
    protocolFilterTooltip: '排除指定协议的节点，所有输出格式均生效',
    ssMethodFilter: 'ShadowSocks 加密方法过滤',
    ssMethodFilterTooltip: '排除指定加密方法的 ShadowSocks 节点，多个方法用逗号分隔',
  ...
  'en-US': {
    ...
    protocolFilterTooltip: 'Exclude nodes that use selected protocols from every output format',
    ssMethodFilter: 'ShadowSocks Method Filter',
    ssMethodFilterTooltip: 'Exclude ShadowSocks nodes using these methods, separated by commas',
